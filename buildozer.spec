...
title = COINEX_AUTOMATIC_TRADING_v4

# (str) Package name
package.name = COINEX_AUTOMATIC_TRADING_v4
...
requirements = python3,kivy,kivy-garden,matplotlib,numpy,pillow,requests,qrcode, android
...
icon.filename = %(source.dir)s/coinex.png
...
# Para usar almacenamiento externo
